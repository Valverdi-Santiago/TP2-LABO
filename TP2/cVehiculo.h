...
public:
	...
	bool Viajar(cCiudad *ciudadDestino,cPersona* persona);
	...
	string To_String();
	void Sumar_KilometrosRecorridos(float kilometros, cPersona* persona,int Cant, ListaT<cPeaje>* ListaPeajes);
